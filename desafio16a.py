...
Ex: 6 cigarros por hora perde 1 hora de vida. Então 6 vezes 24 horas 
fazem o total de 144 cigarros que faz o fumante perder 1 dia de vida.
1 ano são 365 dias.
'''
...
# poderia ser feito assim na linha de baixo: print('O numero de dias a menos de vida e: ', menos_dia_vida)

print('O número de dias a menos de vida é {:.2f}'.format(menos_dia_vida))
